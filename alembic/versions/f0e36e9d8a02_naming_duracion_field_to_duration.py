...
def upgrade() -> None:
    ...
    op.add_column('investment_profile', sa.Column('duration', sa.Numeric(), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('investment_profile', sa.Column('duracion', sa.Numeric(), nullable=True))
